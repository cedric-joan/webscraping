...
def get_title():
    ...
    return book_title.replace("!", " ").replace("?", " ").replace("%", " ").replace("$", " ").replace("@", "-").replace("~", " ")
...
def download_images():
    ...
    name_book = get_title()
    with open(name_book.replace(":", "-").replace(" ", "-").replace("/", "-").replace('"', "-").replace("'", "-").replace("*", " ").replace("...", "-") + ".jpg", "wb") as handler:
        handler.write(img_data)


def save_images():
    name_dir = get_caterogy()
    path = f"c:/Users/33640/Desktop/data_images/{name_dir}"
    try:
...
one_book = [ get_book_url() , get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]

#  extraction des données pour un livre
with open("c:/Users/33640/Desktop/data_images/Business.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    writer.writerow(one_book)

# # extraction et écriture des données pour les livres d'une catégorie dans un fichier csv
with open("c:/Users/33640/Desktop/data_images/music.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for music in musics:
        ...
        music = [ music , get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/travel.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for travel in travels:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        travel = [travel, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/mustery.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,3):
        ...
        for urls in urls_pages:
            ...
            for urls_books_mustery in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                urls_books_mustery = [ urls_books_mustery, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/historical_fiction.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,3):
        ...
        for urls in urls_pages:
            ...
            for urls_books_historical_fictions in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                urls_books_historical_fictions = [ urls_books_historical_fictions, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/sequential_art.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,5):
        ...
        for urls in urls_pages:
            ...
            for urls_books_sequential in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                urls_books_sequential = [ urls_books_sequential, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/classic.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for classic in classics:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        classic = [ classic, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/philosophy.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for philosophy in philosophys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        philosophy = [ philosophy, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/romance.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,3):
        ...
        for urls in urls_pages:
            ...
            for urls_books_romance in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                urls_books_romance = [ urls_books_romance, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/womens_fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for womens_fiction in womens_fictions:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        womens_fiction = [ womens_fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,5):
        ...
        for urls in urls_pages:
            ...
            for fiction in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                fiction = [ fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/children.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,3):
        ...
        for urls in urls_pages:
            ...
            for children in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                children = [ children, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/religion.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for religion in religions:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        religion = [ religion, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/non_fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,7):
        ...
        for urls in urls_pages:
            ...
            for non_fiction in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                non_fiction = [ non_fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/default.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,9):
        ...
        for urls in urls_pages:
            ...
            for default in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                default = [ default, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/science_fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for science_fiction in science_fictions:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        science_fiction = [ science_fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/sport_and_game.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for sport_and_game in sport_and_games:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        sport_and_game = [ sport_and_game, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/add_a_comment.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,5):
        ...
        for urls in urls_pages:
            ...
            for add_a_comment in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                add_a_comment = [ add_a_comment, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/fantasy.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,4):
        ...
        for urls in urls_pages:
            ...
            for fantasy in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                fantasy = [ fantasy, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/new_adult.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for new_adult in new_adults:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        new_adult = [ new_adult, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/young_adult.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,4):
        ...
        for urls in urls_pages:
            ...
            for young_adult in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                young_adult = [ young_adult, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/science.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for science in sciences:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        science = [ science, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/poetry.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for poetry in poetrys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        poetry = [ poetry, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/paranormal.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for paranormal in paranormals:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        paranormal = [ paranormal, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/art.csv", "w") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for art in arts:
        r = requests.get(art)
        soup = BeautifulSoup(r.content, "html.parser")
        art = [ art, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
        writer.writerow(art)        
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/psychology.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for psychology in psychologys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        psychology = [ psychology, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/autobiography.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for autobiography in autobiographys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        autobiography = [ autobiography, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/parenting.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for parenting in parentings:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        parenting = [ parenting, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/adult_fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for adult_fiction in adult_fictions:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        adult_fiction = [ adult_fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/humor.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for humor in humors:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        humor = [ humor, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/horror.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for horror in horrors:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        horror = [ horror, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/history.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for history in historys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        history = [ history, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
with open("c:/Users/33640/Desktop/data_images/food_and_drink.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for i in range(1,3):
        ...
        for urls in urls_pages:
            ...
            for food_and_drink in urls:
                ...
                soup = BeautifulSoup(r.content, "html.parser")
                food_and_drink = [ food_and_drink, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/christian_fiction.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for christian_fiction in christian_fictions:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        christian_fiction = [ christian_fiction, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/business_category.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for business in businesss:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        business = [ business, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/biography.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for biography in biographys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        biography = [ biography, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/thriller.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for thriller in thrillers:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        thriller = [ thriller, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/contemporary.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for contemporary in contemporarys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        contemporary = [ contemporary, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/spirituality.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for spirituality in spiritualitys:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        spirituality = [ spirituality, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/academic.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for academic in academics:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        academic = [ academic, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/self_help.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for self_help in self_helps:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        self_help = [ self_help, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/historical.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for historical in historicals:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        historical = [ historical, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/christian.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for christian in christians:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        christian = [ christian, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/suspense.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for suspense in suspenses:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        suspense = [ suspense, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/short_stories.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for short_storie in short_stories:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        short_storie = [ short_storie, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/novels.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for novel in novels:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        novel = [ novel, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/health.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for health in healths:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        health = [ health, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/politics.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for politic in politics:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        politic = [ politic, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/cultural.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for cultural in culturals:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        cultural = [ cultural, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/erotica.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for erotica in eroticas:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        erotica = [ erotica, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
...
# écrire les données pour chaque catégorie dans un fichier
with open("c:/Users/33640/Desktop/data_images/crime.csv", "w", encoding="utf-8") as file_csv:
    writer = csv.writer(file_csv, delimiter=",")
    writer.writerow(headers_data)
    ...
    for crime in crimes:
        ...
        soup = BeautifulSoup(r.content, "html.parser")
        crime = [ crime, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url(), save_images()]
        writer.writerow(crime)

# # écrire les données de tous les livres pour toutes les catégories dans un seul fichier csv
with open("c:/Users/33640/Desktop/data_images/all_data_books.csv", "w", encoding="utf-8" ) as f:
    writer = csv.writer(f, delimiter=",")
    writer.writerow(headers_data)
    for i in range(1,51): 
        urls = f"http://books.toscrape.com/catalogue/category/books_1/page-{str(i)}.html"
        req = requests.get(urls)
        soop = BeautifulSoup(req.content, "html.parser")
        anchors = soop.find_all("div", class_="image_container")
        for anchor in anchors:
            links = anchor.find("a")["href"]
            links = requests.compat.urljoin(urls, links)
            r = requests.get(links)
            soup = BeautifulSoup(r.content, "html.parser")
            links = [ links, get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url()]
