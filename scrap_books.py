...
with open("data_book.csv", "w") as file_csv:
    ...
    for music in musics:
        ...
        music = [ music , get_caterogy(), get_title(), get_description(), get_upc(), get_price_excl(), get_price_in(), get_num_available(), get_rev_rating(), get_image_url()]
